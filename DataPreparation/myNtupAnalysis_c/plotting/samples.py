...
# }
  ...
  d_samp = {
    ...
    'ttbar'    :{'type':'bkg', 'leg':'t#bar{t}',                  'f_color':kRed+1,   'path':'ttbar'+bkg_suffix},
    ...
    'Zeejets'    :{'type':'bkg', 'leg':'Z(ee)+jets',                    'f_color':kAzure-9,  'path':'Zeejets'+bkg_suffix},
    'Zmmjets'    :{'type':'bkg', 'leg':'Z(mm)+jets',                    'f_color':kAzure-8,  'path':'Zmmjets'+bkg_suffix},
    'Zttjets'    :{'type':'bkg', 'leg':'Z(tt)+jets',                    'f_color':kAzure-7,  'path':'Zttjets'+bkg_suffix},
    ...
    'diboson2L'  :{'type':'bkg', 'leg':'Diboson(ll)',             'f_color':kBlue +2, 'path':'diboson2L'+bkg_suffix},
     ...
     'diboson4L'  :{'type':'bkg', 'leg':'Diboson(llll)',             'f_color':kBlue +5, 'path':'diboson4L'+bkg_suffix},
