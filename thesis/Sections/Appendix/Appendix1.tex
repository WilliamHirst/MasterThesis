...
\begin{figure}[H]
    ...
    with and without a \ac{PCA}. The size of each "slice" represents the relative size of the significance and the color around each 
    point displays the method with the largest sensitivity for the respective combination.}
    \label{fig:NNPCAComp}
\end{figure}

\subsection{Comparing Models Trained on Original and Full Statistics Signal}\label{appendix:BigVsSmall}
\begin{figure}[H]
    \makebox[\linewidth][c]{%
    \centering
    \begin{subfigure}{.65\textwidth}
