...
\begin{figure}[H]
    ...
    \caption[\ac{MC} and real data comparison and event distribution for each channel over $P_t$ for the first, 
    second and third lepton. Similarly, the distribution over $\eta$ for the first, second and third lepton.]{
    \ac{MC} and real data comparison and event distribution for each channel over $P_t$ for the third \ref{fig:lep3_Pt} 
...
\begin{figure}[H]
    ...
    \caption[\ac{MC} and real data comparison and event distribution for each channel over $\phi$ for the first, 
    second and third lepton. Similarly, the distribution over $m_t$ for the first, second and third lepton.]{\ac{MC} 
    and real data comparison and event distribution for each channel over $\phi$ for the first \ref{fig:lep1_Phi}, 
...
\begin{figure}[H]
    ...
    \caption[\ac{MC} and real data comparison and event distribution for each channel over the charge for the first,
    second and third lepton. Similarly, the distribution over the flavor for the first, second and third lepton]{\ac{MC} 
    and real data comparison and event distribution for each channel over the charge for the first \ref{fig:lep1_Charge},
...
\begin{figure}[H]
    ...
    \caption[\ac{MC} and real data comparison and event distribution for each channel over $\Delta R$ \ref{fig:deltaR}
    ...
    The distribution over the significance of the missing transverse energy and the sum of $P_t$.]{\ac{MC} and real 
    data comparison and event distribution for each channel over $\Delta R$ \ref{fig:deltaR} and the azimuthal
...
\begin{figure}[H]
    ...
    certainty.]{\ac{MC} and real data comparison and event distribution for each channel over the sum of $P_t$
