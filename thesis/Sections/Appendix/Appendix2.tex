...
\begin{figure}[H]
    ...
    \caption[\acs{MC} simulated and measured data comparison and event distribution for each channel over $P_t$ for the first, 
    second and third lepton. Similarly, the distribution over $\eta$ for the first, second and third lepton.]{
        \acs{MC} simulated and measured data comparison and event distribution for each channel over $P_t$ for the third \ref{fig:lep3_Pt} 
