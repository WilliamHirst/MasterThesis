...
\\
\newline
In minimizing the error defined by $\mathcal{C}$, we can apply several optimization algorithms described in 
section \ref{subsec:Opti}. Common for the algorithms is the use of the gradient of the function in regard to 
