...
\begin{figure}
    ...
    signal and background separately.]{A calculated visualization of a 3 layer MaxOut network. Each path 
    represents a data point where all connected nodes were the largest activation in their respective 
...
\begin{figure}
    ...
    \caption[A calculated visualization of the activation of a 3 layer MaxOut network, after training and displaying the
    the results for two signal with each their own mass combination, highlighting the difference between two spesific nodes.]{
...
\begin{figure}
    ...
    \caption[A plot comparing the \ac{AUC} score made after each epoch on both the training and validation set, between a dense \ac{NN} 
