...
\begin{figure}
    ...
    \caption{A calculated visualization of an untrained MaxOut network with three hidden layers. Each path 
    represents a data point where all connected nodes were the largest activation in their respective 
    group. The distribution on the far right represent the output distribution for the background (pink)
    and signal (blue).
    }
    \label{fig:BTraining}
\end{figure}
