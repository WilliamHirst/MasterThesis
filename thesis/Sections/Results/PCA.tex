...
\begin{figure}
    ...
    with and without a \ac{PCA}.]{Two pie-plots comparing sensitivity on the original signal set, where each figure shows the comparison between a model trained on data 
