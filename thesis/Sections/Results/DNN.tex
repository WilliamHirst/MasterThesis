...
hence force be referred to as \ac{OMM}), $\tilde{\chi}_1=250$ and $\tilde{\chi}_2=550$GeV, while figure \ref{fig:SeveralMass} presents the 
...
which lie on the edges of the grid.} in the figure \ref{fig:SeveralMass} as well as the point in the middle, $\tilde{\chi}_1=250$ and $\tilde{\chi}_2=550$GeV.\\
\begin{figure}
    \makebox[\linewidth][c]{%
    \centering
    \begin{subfigure}{.6\textwidth}
...
To test this theory, I drew the \ac{AUC} score made after each epoch on both the training and validation set
for the \ac{OMM}  and the \ac{SMM}, shown in Figure \ref{fig:oneMassHist} and \ref{fig:SeveralMassHist}, respectively. By comparing the two figures,
