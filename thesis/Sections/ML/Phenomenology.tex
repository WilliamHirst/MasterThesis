...
to the output of the model where N is number of points. The datasets contain a set of vectors with length equal to the number 
...
\\
The goal of supervised learning is that model can apply any attained knowledge from 
