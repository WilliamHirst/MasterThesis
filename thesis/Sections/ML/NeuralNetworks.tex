...
\subsection{Overfitting, Regularization and Network Ensembles}
...
attempts to minimize the risk you are doing so, we call these methods' \emph{regularization}. In \ac{ML}, regularization 
...
\\
A simple approach is to introduce \emph{early stopping}. Early stopping simply 
