...
place \emph{rectangular-cuts} on a data set, $X$
to effectively map $\textbf{x}_i\rightarrow t_i$. In other words, the goal of a \ac{DT} is to 
use the data to create a collection of thresholds $\bf{\mathcal{C}} \sf =\{c_1, 
c_2,...,c_{N_c}\}$, which when applied to a new data set and target, 
...
applies a set of thresholds on the data to find the route applicable to a target. 
\begin{figure}
    \centering
...
\subsection{An Introduction to Gradient Boosting}
