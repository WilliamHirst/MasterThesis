...
and $M_{\tilde{\chi}_2}\in[100,800]$. In the beginning of my analysis I only received a subset of the full signal set. In the figure
I have marked the original data set\footnote{I.e. the first data set I received.} with a white label in the top right corner of the box.
\\
Inn the first data set I received (which will be referred to as the \emph{original} data set.) there are a total of 30 different mass combinations 
in the range from $M_{\tilde{\chi}_1}\in[0,400]$ and $M_{\tilde{\chi}_2}\in[400,800]$. 
\begin{figure}
  \centering
