...
be studying data produced by \ac{ATLAS}, with a luminosity of $139.0fb^{-1}$. This means
the detector is measuring an experiment in which $139\times10^{15}$ events are colliding per 
$1.0fb^{-1}(10^{-39}m^2)$ of area. With amounts of data this large, data handling and 
