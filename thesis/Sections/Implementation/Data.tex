...
\subsection{The Structure of the Data Set - Ntuples}
...
by the popular frameworks like, \emph{$MadGraph5\_aMC@NLO$} and \emph{$Pythia 8.2$} \cite{alwall_automated_2014, sjostrand_introduction_2015}. Through simulation, we 
