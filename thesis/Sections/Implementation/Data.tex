...
grid showing the different mass combinations searched for in this analysis. The figure shows the data set containing masses ranging from ${\tilde{\chi}_1}\in[0,400]$
and ${\tilde{\chi}_2}\in[100,800]$\footnote{The chargino, $\tilde{\chi}^{\pm}_1$ and second neutralino, $\tilde{\chi}_2$ are mass degenerate, 
