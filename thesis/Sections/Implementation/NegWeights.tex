...
weights have little effect on the shape of the distribution of the full data set, which motivates treating the 
...
\end{figure}
How one chooses to deal with this problem can heavily affect the results and thus many solutions 
are suggested. Given the main focus of this report, the simplest solution was chosen. The solution was 
motivated by the internal notes of the \ac{ATLAS} article \cite{Aad:2800889}, which introduced the solution 
