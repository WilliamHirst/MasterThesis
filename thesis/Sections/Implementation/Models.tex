...
today. This means, that regardless of the brave attempt made by voluntary contributors and many large companies,
...
\begin{figure}
    ...
    \caption{A visual summary of the network architectures used in this analysis, for the ordinary dense \ac{NN}, the \ac{PNN}
    and the maxout model.}
    \label{fig:arch}
\end{figure}
