...
of mysticism. The second is the size of the data set. The larger the data set, the more data 
...
architecture. As a consequence, the default parameters\footnote{See \url{https://xgboost.readthedocs.io/en/stable/parameter.html}
