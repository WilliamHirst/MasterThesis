...
of a \ac{NN}, than compared to a \verb!XGBoost!. Additionally, this was motivated by the selfish reason
being that I found the networks more interesting to study and dissect. Therefore, most of the 
analysis, comparisons and discussions are focused on the networks, while \verb!XGBoost! is included 
...
\verb!TensorFlow!\footnote{See $\href{https://www.tensorflow.org/api_docs/python/tf/keras/optimizers/Adam}{https://www.tensorflow.org/api_docs/python/tf/keras/optimizers/Adam}$
...
{https://xgboost.readthedocs.io/en/stable/parameter.html} for a complete overview of default parameters.} of the \verb!XGBoost! model have been used. 
