...
\\
In figure \ref{fig:Dist1}, I have drawn the distribution of the transverse momentum, $P_t$ for the first \ref{fig:lep1_Pt}, 
second \ref{fig:lep2_Pt} and third \ref{fig:lep3_Pt} lepton. As per definition we see the peak of the distribution for each
lepton moving closer to 0 in order of rank of lepton. Not surprisingly \footnote{It is often }
\begin{figure}
