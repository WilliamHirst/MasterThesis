...
whereas $Diboson(lll)$, $Top-Other$ and $t\bar{t}$ decrease much slower. High amounts of missing energy is an indicator that 
...
\begin{figure}
    ...
    \caption[\ac{MC} simulated and measured data comparison and event distribution for each channel for the $P_t$ and $\eta$ of the leading lepton 
