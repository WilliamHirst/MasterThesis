...
\begin{figure}
    ...
    \caption{References to figures for all event specific feature distribution.}
\end{figure}
...
\\
In the $P_t$ figures we can clearly see that for (relatively) small $P_t$ ($<100GeV$) all events lay well within a range of $[0.9-1.1]$ ratio. 
...
we can deduce that this trend continues thought the full feature set. Additionally to studying the ration for each features in different bins,
