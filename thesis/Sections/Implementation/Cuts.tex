...
\\
As for the requirements for the signal leptons, we require all baseline requirements to have passed 
...
track parameter is also used to ensure origin from primary vertex.
\begin{figure}[H]
