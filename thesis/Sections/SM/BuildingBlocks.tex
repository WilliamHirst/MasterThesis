...
that emerge between these relativly simple particles? Through the creation of \ac{SM} and countless 
experiment, we discovered that fources are nothing but interactions between particles and fields.
The \ac{SM} decribes all forces as a fields which are mediated through a particles, we call bosons. 
\\
