...
c      integer i
      real*8 tp,pp,ee,kpc,cc,partial,total,dspbkdiffm,dspbkdiff,
     & dspbsigmavpbar
     ...
     & rlist(5000)
      ...
      common/beusetcom/ epsabs1,epsabs2,epsabs3,beuset,ndigits
      ...
      elseif(pbpropmodel.eq.3) then
        ...
        write(*,*) 'dspbtd15beu called with wrong pbpropmodel'
...
c corresponding to a central portion of the halo
 ...
 23        call dqagse(dspbbeuparm,0.d0,1.d0,epsabs3,epsrel,limit,
     ...
     &       *2.d0/(pbrh*kpc)**2
      ...
      write(*,*) 'program stopped'
      stop 
c  dspbtd15beu in 10^15 sec 
 20   dspbtd15beu = total
      return
      end
