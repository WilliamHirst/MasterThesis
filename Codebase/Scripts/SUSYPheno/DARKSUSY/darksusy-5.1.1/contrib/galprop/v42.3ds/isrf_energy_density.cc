...
// cout<<"isrf_energy_density  "<<rr<<" "<<zz<<endl;
   ...
   int iz=(int)((zz-galaxy.z_min)/galaxy.dz + 0.0001);
   ...
   {
      int ir=(int)((rr-galaxy.r_min)/galaxy.dr + 0.0001);
...
// cout<<"isrf_energy_density rr zz ir iz energy_density "<<rr<<" "<<zz<<" "<<ir<<" "<<iz<<" "<<energy_density<<endl;
   }

   if(galaxy.n_spatial_dimensions==3)
   {
      int ix=(int)((rr-galaxy.x_min)/galaxy.dx + 0.0001);
