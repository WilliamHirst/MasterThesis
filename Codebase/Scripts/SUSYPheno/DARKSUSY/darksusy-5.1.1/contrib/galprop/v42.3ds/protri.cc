...
#include"constants.h"
/*
extern "C" int tridag_ext    ( float*, float*, float*, float*, float*,int,int);
extern "C" int tridag_sym_ext( float*, float*, float*, float*, float*,int,int);
*/
 
           int tridag_ext    ( float*, float*, float*, float*, float*,int,int);
...
/*
float Nx1[NMAX],Nx2[NMAX],Nx3[NMAX],Nx0[NMAX],Rx[NMAX];
float Ny1[NMAX],Ny2[NMAX],Ny3[NMAX],Ny0[NMAX],Ry[NMAX];
float Nz1[NMAX],Nz2[NMAX],Nz3[NMAX],Nz0[NMAX],Rz[NMAX];
float Np1[NMAX],Np2[NMAX],Np3[NMAX],Np0[NMAX],Rp[NMAX];

float alpha1_xx[NMAX],alpha1_yy[NMAX],alpha1_zz[NMAX],alpha1_pp[NMAX];
float alpha2_xx[NMAX],alpha2_yy[NMAX],alpha2_zz[NMAX],alpha2_pp[NMAX];
float alpha3_xx[NMAX],alpha3_yy[NMAX],alpha3_zz[NMAX],alpha3_pp[NMAX];

float alpha1_x0[NMAX],alpha1_y0[NMAX],alpha1_z0[NMAX]; 

float total_source_function_x[NMAX];
float total_source_function_y[NMAX];
float total_source_function_z[NMAX];
float total_source_function_p[NMAX];
*/


float *Nx1      ,*Nx2      ,*Nx3      ,*Nx0      ,*Rx      ;
float *Ny1      ,*Ny2      ,*Ny3      ,*Ny0      ,*Ry      ;
float *Nz1      ,*Nz2      ,*Nz3      ,*Nz0      ,*Rz      ;
float *Np1      ,*Np2      ,*Np3      ,*Np0      ,*Rp      ;

float *alpha1_xx      ,*alpha1_yy      ,*alpha1_zz      ,*alpha1_pp      ;
float *alpha2_xx      ,*alpha2_yy      ,*alpha2_zz      ,*alpha2_pp      ;
float *alpha3_xx      ,*alpha3_yy      ,*alpha3_zz      ,*alpha3_pp      ;

float *alpha1_x0      ,*alpha1_y0      ,*alpha1_z0       ; 
...
nkt=particle.n_xgrid*particle.n_ygrid*particle.n_zgrid*particle.n_pgrid; 
 ...
 cout<<" Assigning arrays with dimension="<<nkt<<endl;
     protri_init=1;
       ...
       Nx1=new float[nkt]; Nx2=new float[nkt]; Nx3=new float[nkt]; Nx0=new float[nkt]; Rx=new float[nkt];       
       Ny1=new float[nkt]; Ny2=new float[nkt]; Ny3=new float[nkt]; Ny0=new float[nkt]; Ry=new float[nkt];      
       Nz1=new float[nkt]; Nz2=new float[nkt]; Nz3=new float[nkt]; Nz0=new float[nkt]; Rz=new float[nkt];       
       Np1=new float[nkt]; Np2=new float[nkt]; Np3=new float[nkt]; Np0=new float[nkt]; Rp=new float[nkt];       

       alpha1_xx=new float[nkt];  alpha1_yy=new float[nkt];  alpha1_zz=new float[nkt]; alpha1_pp=new float[nkt];       
       alpha2_xx=new float[nkt];  alpha2_yy=new float[nkt];  alpha2_zz=new float[nkt]; alpha2_pp=new float[nkt];       
       alpha3_xx=new float[nkt];  alpha3_yy=new float[nkt];  alpha3_zz=new float[nkt]; alpha3_pp=new float[nkt];         

       alpha1_x0=new float[nkt];  alpha1_y0=new float[nkt];  alpha1_z0=new float[nkt];         
