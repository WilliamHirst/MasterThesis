...
// REFERENCES:                                                                 
//   A.W.Strong & I.V.Moskalenko 1998, ApJ 509, 212  and references therein    
//=="====!===="====!===="====!===="====!===="====!===="====!===="====!===="====!
...
// some constants
   MA = a*1836.*Mele;                         // MeV, nucleon rest mass
...
double electron_loss(double emev, double nhcm3, double nhicm3, double he_to_h, 
   ...
   double PIR02C,PIR02MC2C,AFR02MC2C,ZHe,nhe_cm3,gam_e,bet_e,tmev,
...
// some constants
   ...
   tmev = emev-Mele;                          // electron kinetic energy
...
main()
{
   double emev,Ek,nhcm3=0.01,nhicm3=0.01,he_to_h=0,aion,coul;
   int  z=6,a=12, i;
   for(Ek=100, i=0; i<30; i++, Ek*=1.4)
   {
      emev=a*(940+Ek);
      nucleon_loss(z,a,emev,nhcm3,nhicm3,he_to_h,&aion,&coul);
      cout<<" >> "<<Ek<<" "<<a*Ek*1.e6/aion/year2sec<<" "<<a*Ek*1.e6/coul/year2sec<<endl;
   }
}
*/
