...
{
   int stat=0;
   char workstring[400];//AWS20040227
   ...
   electron_g_0 = 0.;                 // IMOS20031012
   electron_rigid_br0 =0.;            // IMOS20031012
   electron_source_normalization =1.; // IMOS20031016
   source_normalization =1.;          // IMOS20030129
...
// stat= read_galdef_parameter(filename,parstring,&X_CO          );                       //AWS20040227
   stat= read_galdef_parameter(filename,parstring,workstring     );                       //AWS20040227
   //   n_X_CO=8;                                                                         //AWS20040227
   n_X_CO=9;                                                                              //AWS20050913
   X_CO=new double[n_X_CO];                                                               //AWS20040227
   //   sscanf(workstring,"%le,%le,%le,%le,%le,%le,%le,%le,%le,%le,%le,%le,%le", // %le for double   comma is separator character
   sscanf(workstring,"%le,%le,%le,%le,%le,%le,%le,%le,%le",                                        //AWS20050627 AWS20050913
	  &X_CO[0] ,&X_CO[1] ,&X_CO[2] ,&X_CO[3], &X_CO[4],&X_CO[5] ,&X_CO[6] ,&X_CO[7],&X_CO[8] );//AWS20040227 AWS20050913
...
void Galdef::print()
{
   ...
   cout<<"  X_CO: ";  for (int i=0;i<n_X_CO;i++) cout<<X_CO[i]<<" "; cout<<endl;//AWS20040227
