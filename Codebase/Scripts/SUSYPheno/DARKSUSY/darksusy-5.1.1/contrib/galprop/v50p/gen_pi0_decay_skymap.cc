...
int Galprop::HIR_iRing(double RR)
{
   int i_Ring;
  if(galdef.HI_survey==8) // 8 rings  AWS20050913
  {
  ...
  if(galdef.HI_survey==9) // 9 rings  AWS20050913
  {
                i_Ring=0; 
   if (RR> 1.5) i_Ring=1;
   if (RR> 3.5) i_Ring=2;
...
{
   cout<<" >>>>gen_pi0_decay_skymap"<<endl;
   int stat=0;
...
//<<theta<<" "<<zz<<" "<<i_comp<<" "<<pi0_aniso_factor<<endl;
	       ...
	       { 
                  ...
                  delta1=  dd*kpc2cm *galaxy.pi0_decay_emiss.d2[ir][iz].s[iEgamma]
                      *galaxy.n_HII.d2[ir][iz].s[0];

                  delta_HI =dd*kpc2cm *galaxy.pi0_decay_emiss.d2[ir][iz].s[iEgamma]              //AWS20041214
                     *(galaxy.n_HI. d2[ir][iz].s[0]                                );            //AWS20041214
                  delta_H2 =dd*kpc2cm *galaxy.pi0_decay_emiss.d2[ir][iz].s[iEgamma]              //AWS20041214
	       ...
	       { 
	             ...
	             *(galaxy.n_HI. d3[ix][iy][iz].s[0] +2*galaxy.n_H2. d3[ix][iy][iz].s[0]);
                  delta1=  dd*kpc2cm *galaxy.pi0_decay_emiss.d3[ix][iy][iz].s[iEgamma] 
	              *galaxy.n_HII.d3[ix][iy][iz].s[0];
	         
                  delta_HI =dd*kpc2cm *galaxy.pi0_decay_emiss.d3[ix][iy][iz].s[iEgamma] 
	             *(galaxy.n_HI. d3[ix][iy][iz].s[0]                                    );    //AWS20041214
                  delta_H2 =dd*kpc2cm *galaxy.pi0_decay_emiss.d3[ix][iy][iz].s[iEgamma] 
...
//cout<<"i_long i_lat "<<i_long<<" "<<i_lat<<endl;
   ...
   {
      cout<<" pi0-decay skymap "<<endl;
      galaxy.pi0_decay_skymap.print();
      cout<<" pi0-decay_HIR skymap "<<endl;
      galaxy.pi0_decay_HIR_skymap.print();
      cout<<" pi0-decay_H2R skymap "<<endl;
