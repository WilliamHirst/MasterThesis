...
extern "C" void bremss_spec_(double*,double*,int*,int*,double*);
extern "C" void set_sigma_(int*);                 // IMOS20020502
extern "C" double e_loss_compton_(double*,double*);
...
extern "C" void nucleon_cs_(int *option, double *Ek1, int *Zp1, int *Zt1, int *At1,
