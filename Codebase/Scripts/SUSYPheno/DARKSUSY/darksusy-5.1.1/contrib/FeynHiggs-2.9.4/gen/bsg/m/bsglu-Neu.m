((-I/18)*MW2*SumOver[All4, 6]*SumOver[Neu4, 4]*
  ((2*SW2*Mat[O8[7]]*UASfC[All4, 5, bTR]*ZNeuC[Neu4, 1]*
    ...
    (MB*B0[MB2, MASf2[All4, bTR], MNeu2[Neu4]]*MNeu[Neu4]*
      (-2*CB*MW*UASf[All4, 6, bTR]*ZNeu[Neu4, 1]*(SW2*ZNeu[Neu4, 1] - 
         3*CW*SW*ZNeu[Neu4, 2]) - 3*Mf[bTR, 3]*UASf[All4, 3, bTR]*
     ...
     ((MB2 - 2*A0[MASf2[All4, bTR]] + 2*A0[MNeu2[Neu4]] + 
        ...
        3*Mf[bTR, 3]*UASf[All4, 6, bTR]*(CW*SW*ZNeu[Neu4, 1] - 
          3*CW2*ZNeu[Neu4, 2])*ZNeuC[Neu4, 3]))/2)))/
