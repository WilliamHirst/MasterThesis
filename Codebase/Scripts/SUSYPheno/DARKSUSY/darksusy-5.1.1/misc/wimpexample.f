...
c...Do the same for neutrino telescope in case we need it
      call dswasetup_private  ! routine is further down this code
...
c...For a description of the channels, see dshayield.f
      do i=1,29
         habr(i)=0.d0
      enddo
c      habr(13)=1.d0 ! W+W-, see dshayield.f for an explaination
      habr(26)=1.d0 ! gluon-gluon
...
c...For a description of the channels, see dswayieldone.f
      ...
      wabr(13)=1.d0 ! W+W-, see dswayieldone.f for an explaination
