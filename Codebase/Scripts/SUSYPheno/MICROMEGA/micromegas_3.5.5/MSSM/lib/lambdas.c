...
/*<         LAMBDA1 = LAMBDA1+DLAM1 >*/
    if(finite(dlam1)) hself_hdec__1.lambda1 += dlam1;
/*<         LAMBDA2 = LAMBDA2+DLAM2 >*/
    if(finite(dlam2)) hself_hdec__1.lambda2 += dlam2;
/*<         LAMBDA3 = LAMBDA3+DLAM3 >*/
    if(finite(dlam3)) hself_hdec__1.lambda3 += dlam3;
/*<         LAMBDA4 = LAMBDA4+DLAM4 >*/
    if(finite(dlam4)) hself_hdec__1.lambda4 += dlam4;
/* --END OF EXTENSION */
/*<  3790	CONTINUE >*/
L3790:
...
/*<       LAMBDA5 = LAMBDA5+DLAM5 >*/
    if(finite(dlam5)) hself_hdec__1.lambda5 += dlam5;
/*<       LAMBDA6 = LAMBDA6+DLAM6 >*/
    if(finite(dlam6)) hself_hdec__1.lambda6 += dlam6;
/*<       LAMBDA7 = LAMBDA7+DLAM7 >*/
    if(finite(dlam7)) hself_hdec__1.lambda7 += dlam7;
/*<        >*/
    d__1 = v;
    d__2 = cosb;
    d__3 = sinb;
