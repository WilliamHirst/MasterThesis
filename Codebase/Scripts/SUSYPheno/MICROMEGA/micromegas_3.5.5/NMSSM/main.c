...
{ double constr0,constrM, constrP;
  ...
  printf("(g-2)/BSM = %.2E (%.2E ,  %.2E  ) \n",constr0,constrM, constrP );
   ...
   slhaWrite("slha.in");
   system("cat spectr decay > HBslha.in");
   HBblocks("HBslha.in");
   System("%s/HiggsBounds  LandH SLHA 5 1 HBslha.in HBslha.out",HIGGSBOUNDS);
...
#ifdef CLEAN 
  system("rm -f inp spectr decay omega nngg.out HB.slha  Key.dat HBslha.in HBslha.out debug_channels.txt debug_predratio.txt slha.in");
#endif 
