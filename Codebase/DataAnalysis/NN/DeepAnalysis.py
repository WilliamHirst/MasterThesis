...
model.add(MaxOut(units=600, num_inputs=nrFeature, num_groups=200, regularizer = regularizers.L1L2(l1=5e-6, l2=5e-5)))
model.add(tf.keras.layers.Dropout(0.2))
model.add(MaxOut(units=600, num_inputs=200, num_groups=200, regularizer = regularizers.L1L2(l1=5e-6, l2=5e-5)))
model.add(tf.keras.layers.Dropout(0.2))
model.add(MaxOut(units=600, num_inputs=200, num_groups=200, regularizer = regularizers.L1L2(l1=5e-6, l2=5e-5)))
model.add(tf.keras.layers.Dropout(0.2))
