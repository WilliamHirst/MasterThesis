...
\begin{frame}{The Supersymmetry signal}
...
\begin{frame}{Maxout, Channel-Out and Stochastic-Channel-Out (SCO)}
    \vspace{0.5cm}
    \center
        \begin{textblock}{0.8}(-0.21, 0.25)
            \includegraphics[width = 0.5\textwidth]{figures/EnsembleCompMaxOut.png}
        \end{textblock}
        \begin{textblock}{0.8}(0.17, 0.25)
            \includegraphics[width = 0.5\textwidth]{figures/EnsembleCompChannelOut.png}
        \end{textblock}
        \begin{textblock}{0.8}(0.424, 0.25)
            \includegraphics[width = 0.335\textwidth]{figures/EnsembleCompSCO.png}
        \end{textblock}
\end{frame}

% \begin{frame}{Visualization and study of sparse pathways from maxout}
%         % \includegraphics[width = 0.5\textwidth]{figures/NetworkVis/BeforeTraining.pdf}
%     \centering
%     \vfill
%     \includegraphics[width = 0.6\textwidth]{figures/NetworkVis/AfterTraining.pdf}
    % \begin{itemize}
...
%     \vfill
%     \begin{center}
%         \includegraphics[width = 0.475\textwidth]{figures/NetworkVis/AfterTrainingBkg.pdf}
%         \includegraphics[width = 0.475\textwidth]{figures/NetworkVis/AfterTrainingSig.pdf}
%     \end{center}
    % \begin{itemize}
    %     \item Visualize activation and \\
    %     paths
...
\begin{frame}{Increasing sensitivity using principal component analysis}
